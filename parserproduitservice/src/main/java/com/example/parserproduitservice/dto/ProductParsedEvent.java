...
public class ProductParsedEvent {
	...
	public ProductParsedEvent(UUID productId, String gtin, String name, String brand,
			String originCountry, String packaging, String normalizedText, Instant parsedAt) {
